// Seleciona os elemtos do formulário.
...
form.onsubmit = (event) => {
  // Previne o recarregamento da página 'onsubmit'.
...
function updateTotals(){
  try{
    ...
    // Formata o valor e remove o R$ que será exibido pela tag <small> com estilo pré customizado via CSS.
